//! Shared request fixtures for `conformance_anthropic_messages_batch.rs`
...
//! `openai_chat_fixtures.rs`'s/`bedrock_converse_fixtures.rs`'s identical
//! one-definition-per-fixture pattern).
#![allow(dead_code)]
